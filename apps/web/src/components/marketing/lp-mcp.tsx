        ...
        <div className="grid gap-12 md:grid-cols-2 md:items-center md:gap-16">
          <div>
            ...
            <p className="mt-4 max-w-[420px] text-[15px] leading-[1.8] text-secondary-foreground">
              MCPは、AIとClipnoteをつなぐ「連携のしくみ」です。名前は難しそうですが、やることはアプリ同士を一度つなぐだけ。あとは会話の中で「保存して」「書き換えて」とお願いするだけで、貼り付け作業そのものが不要になります。現在はClaude（無料プランを含む全プラン）とChatGPT（Plus以上）に対応。設定は数分で完了します。
            </p>
